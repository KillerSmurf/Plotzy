    ...
    public void onPluginEnable(PluginEnableEvent event) {
        if (this.Methods.hasMethod() == false) { //If we don't have a method yet
            if(this.Methods.setMethod(event.getPlugin()) == true) {
                ...
                pl.log.info("[Plotzy] Payment Method Found: " + this.pl.Method.getName() + " version " + this.pl.Method.getVersion() + ".");
            }
        }
    }
    ...
    public void onPluginDisable(PluginDisableEvent event) {
        ...
        if (this.Methods != null && this.Methods.hasMethod()) {
            if(this.Methods.checkDisabled(event.getPlugin()) == true) {
                this.pl.Method = null;
                pl.log.info("[Plotzy] The payment system of choice was disabled. Hopefully you're shutting down or reloading.");
            }
        }
    }
}